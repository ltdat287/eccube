 ...
 * @version $Id: SC_Initial.php 23151 2013-08-28 07:13:59Z michael_nelson $
 */
class SC_Initial {
    ...
    function __construct() {
        ...
        /** EC-CUBEのバージョン */
        define('ECCUBE_VERSION', '2.12.6en');
    }
    ...
    function defineParameter() {
        ...
        if (is_file(CACHE_REALDIR . 'mtb_constants.php')) {
            ...
            $errorMessage = t('c_<div style=\"color: #F00; font-weight: bold; background-color: #FEB; text-align: center\">Please grant T_ARG1 user write access (777, etc.)</div>_01', array('T_ARG1' => CACHE_REALDIR), array('device_type_id' => FALSE));
            ...
            die(t('c_T_ARG1../mtb_constants_init.php does not exist_01', array('T_ARG1' => CACHE_REALDIR), array('device_type_id' => FALSE)));
        }
    }
